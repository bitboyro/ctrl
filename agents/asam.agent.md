...
When validating his changes, he prefers `ctrl check`, `ctrl list`, and `ctrl info` to verify behavior. He reaches for raw shell only when verifying behavior that ctrl commands do not expose.
